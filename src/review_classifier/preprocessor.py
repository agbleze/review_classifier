...
#%%
raw_datapath = NewsDataset.get_datapath(data_foldername='data', data_filename='product_reviews.csv')


#%%
data_segmented = NewsDataset.segment_dataset(data_path=raw_datapath)
...
review_df_cleaned.to_csv(NewsDataset.get_datapath(data_foldername='data_splitted', data_filename='review_df_split.csv'))
